# The task
Your task is to construct a *generic* [Input Range](https://tour.dlang.org/tour/en/basics/ranges) that takes
an array, __copies__ it and then presents said copy through it's range interface.

Also included, an introduction to D's type inference.
